...
/**
 *grabs page heading and content
 *
 */

	public function SelectPage($pageName){
try{
$pageid = $this->db->selectRow('SELECT heading, content FROM ' . $this->dbTablePrefix . 'page WHERE page_name = ?' , [$pageName] );
}
catch (Error $e) {
                        throw new DatabaseError($e->getMessage());
                }
print $pageid['content'];
